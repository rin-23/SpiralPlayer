...
@synthesize numOfSectionsVisible, container, startTransform, numOfSectionsTotal, segmentArray = segmentArray_;
...
-(id) initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.segmentArray = [[NSMutableArray alloc] initWithCapacity:self.numOfSectionsTotal];
...
- (void) drawWheel {
    ...
    for (int i = -3; i < self.numOfSectionsVisible - 3; i++) {
        ...
        cloveImage.image = [UIImage imageNamed:[NSString stringWithFormat:@"icon%i.png", i+3]];
